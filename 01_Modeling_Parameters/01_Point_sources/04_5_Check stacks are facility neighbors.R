...
points_near <- readRDS(paste0("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/MNRISKS/", inv_year, " MNRISKS/", "_development/1. Modeling parameters/1. Point sources/04_Cleaned_stack_params_with_mod_coords.Rdata"))
...
for(i in far_stacks){
  points_far_stacks <- filter(points_dupes, source_name == i)
...
write_csv(new_stack_locs, paste0("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/MNRISKS/2017 MNRISKS/_development/1. Modeling parameters/1. Point sources/qc_stack_params/final_stack_locs/", new_i, "_new_stack_loc.csv"))
...
new_stacks <- list.files("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/MNRISKS/2017 MNRISKS/_development/1. Modeling parameters/1. Point sources/qc_stack_params/final_stack_locs", full.names = T)

#setwd("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/MNRISKS/2017 MNRISKS/_development/1. Modeling parameters/1. Point sources/qc_stack_params/final_stack_locs/")
...
all_stacks <- left_join(stacks, new_fac_stacks_all, by = c("source_name", "source_id", "release_point_id"))
...
# SAVE
saveRDS(all_stacks, paste0("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/MNRISKS/", inv_year, " MNRISKS/", "_development/1. Modeling parameters/1. Point sources/04_Cleaned_stack_params_with_mod_coords.Rdata"))
